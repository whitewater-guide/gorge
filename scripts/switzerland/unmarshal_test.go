...
func TestSwitzerland_UnmarshalXML(t *testing.T) {
	assert := assert.New(t)
	data := `
				...
				Parameters: []swissParameter{
					{
						...
						Name:     "Pegel m ü. M.",
						Unit:     "m ü. M.",
						Datetime: swissTime{time.Date(2019, time.February, 9, 20, 40, 0, 0, time.UTC)},
						Value:    nulltype.NullFloat64Of(429.09),
					},
				},
			},
			{
				...
				Parameters: []swissParameter{
					{
						...
						Unit:     "°C",
						Datetime: swissTime{time.Date(2019, time.February, 9, 20, 40, 0, 0, time.UTC)},
						Value:    nulltype.NullFloat64Of(5.3),
					},
					{
						XMLName:  xml.Name{Local: "parameter"},
						Type:     2,
						...
						Unit:     "m ü. M.",
						Datetime: swissTime{time.Date(2019, time.February, 9, 20, 40, 0, 0, time.UTC)},
						Value:    nulltype.NullFloat64Of(374.49),
					},
					{
						XMLName:  xml.Name{Local: "parameter"},
						Type:     10,
