...
import (
	...
	"github.com/whitewater-guide/gorge/scripts/nz_bop"
	"github.com/whitewater-guide/gorge/scripts/nz_waikato"
...
func init() {
	...
	Registry.Register(nz_waikato.Descriptor)
	Registry.Register(nz_bop.Descriptor)
